...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in one_gene:
        if people[person]["father"] is None and people[person]["mother"] is None:
            ...
            # parents, if only from father or only from mother
            # father
            father = 0
            mother = 0
            if people[person]["father"] in zero_gene:
            ...
            result *= father*(1-mother)+(1-father)*mother
    ...
    for person in two_genes:
        ...
        if people[person]["father"] is None and people[person]["mother"] is None:
            ...
            # parents, if from father and from mother
            # father
            if people[person]["father"] in zero_gene:
                result *= PROBS["mutation"]
            elif people[person]['father'] in one_gene:
...
def normalize(probabilities):
    ...
    for person in probabilities:
        sum = probabilities[person]["gene"][0] + \
            probabilities[person]["gene"][1]+probabilities[person]["gene"][2]
        for gene in probabilities[person]["gene"]:
            probabilities[person]["gene"][gene] /= sum

        sum = probabilities[person]["trait"][False] + \
            probabilities[person]["trait"][True]
        for trait in probabilities[person]["trait"]:
            probabilities[person]["trait"][trait] /= sum
